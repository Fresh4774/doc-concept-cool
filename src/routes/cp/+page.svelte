...
<div class="flex min-h-screen w-full flex-col">
	<main class="my-5">
		<div class="cookiePolicy">
			...
			<p>
				This Cookie Policy explains how we at Aquin ("Company," "we," "us," and "our") uses cookies
				and similar technologies to recognize you when you visit our website at https://aquin.app
				("Website", “Web App”, “Application”). It explains what these technologies are and why we
			...
			<p>
				Cookies set by the website owner (in this case, Aquin) are called "first-party cookies."
			...
			<ul>
				<li>
					<a
						href="https://support.google.com/chrome/answer/95647#zippy=%2Callow-or-blockcookies"
						target="_blank"
						rel="noreferrer">Chrome</a
					>
				</li>
				<li>
					<a
						...
						target="_blank"
						rel="noreferrer">Internet Explorer</a
					>
				</li>
				<li>
					<a
			...
			<p>
				...
				your Flash player to block Flash Cookies storage using the tools contained in the <a
					href="https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager07.ht
  ml"
					target="_blank"
					rel="noreferrer">Website Storage Settings Panel</a
				>. You can also control Flash Cookies by going to the
				<a
					href="https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager03.ht
  ml"
					target="_blank"
					rel="noreferrer">Global Storage Settings Panel</a
